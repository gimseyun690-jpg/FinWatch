...
상태: v0.1  
기준일: 2026-07-13  
범위: NEWS_SUMMARY 입력 전처리, 프롬프트, AI 공급자, 결과 검증, 캐시, 사용량·비용, 오류·안전

## 1. 목적과 현재 상태

이 문서는 01_REQUIREMENTS.md의 A-01부터 A-06, 02_ARCHITECTURE.md의 AI 뉴스 요약 흐름, 03_API_SPEC.md의 AI·관리자 API를 실제 구현 가능한 운영 계약으로 구체화한다.
