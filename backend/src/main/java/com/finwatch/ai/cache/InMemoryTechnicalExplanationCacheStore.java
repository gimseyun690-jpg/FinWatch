...
@Component
@Profile("demo")
public class InMemoryTechnicalExplanationCacheStore implements TechnicalExplanationCacheStore {
    ...
    private record Entry(TechnicalExplanationCacheValue value, Instant expiresAt) {
    }
}
